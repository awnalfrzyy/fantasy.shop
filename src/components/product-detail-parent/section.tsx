        ...
        <div className="relative pr-18 pl-18 ">
            ...
            <div className="flex justify-between py-10">
                ...
                <div className="flex gap-6">
                    <Button variant="secondary" className="py-6 pr-28 pl-28 rounded-4xl">
                        <SlidersVertical size={24} color="black" />
                    </Button>
                    <Button variant="secondary" className="pr-10 pl-10 py-6 rounded-4xl">Latest
                        <span>
                            <ChevronDown size={24} color="black"></ChevronDown>
                        </span>
                    </Button>
                    <Button className="pr-10 pl-10  py-6 rounded-4xl">Write a Review</Button>
                </div>
            </div>
            ...
            <div className=" p-10 flex justify-center">
                <Button variant="outline" className="pr-14 pl-14 py-7 rounded-4xl">Load more reviews</Button>
            </div>
        </div>
    );
}
